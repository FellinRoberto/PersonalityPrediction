...
// normal tree setting
// #define FAST // faster evaluation of PT ==> static memory will be used
#define MAX_NUMBER_OF_CHILDREN_PT 100 + 200  // USED ONLY FOR FAST EVALUATION of PT, i.e. when "#define FAST"

#define MAX_NUMBER_OF_CHILDREN  5000             // max children in a tree
#define MAX_PARSE_TREE_LENGTH   50000            // lenght in characters of the parenthetic format
#define MAX_NUMBER_OF_NODES             5000*2            // nodes in a tree
#define MAX_NUMBER_OF_PAIRS             50000*10   // number of productions or node pairs - the worst case  is MAX_NUMBER_OF_NODES^2
#define MAX_PRODUCTION_LENGTH   5000*10            // in characters
