...
# MAC CFLAGS= -O3 -arch x86_64 -fno-common -I/System/Library/Frameworks/JavaVM.framework/Headers -g #-Wall -pedantic

#LINUX

 CFLAGS= -g -Wall -fPIC  # -pedantic debugging C-Compiler flags

LD=gcc  # used linker

# MAC LFLAGS= -arch x86_64 -O3 -dynamiclib -framework JavaVM -march=pentium4 # linker flags

#LINUX

LFLAGS=  -O3  -march=pentium4
...
svmlight_tk.so: svm_classify.o svm_common.o tree_manager.o tree_kernel.o
	gcc -o svmlight_tk.so $(LFLAGS) svm_classify.o svm_common.o tree_kernel.o tree_manager.o $(LIBS)

elkfed_ml_svm_SVMLightTK.h: elkfed/ml/svm/SVMLightTK.class
	javah elkfed.ml.svm.SVMLightTK

elkfed/ml/svm/SVMLightTK.class: SVMLightTK.java
	javac -d. SVMLightTK.java
