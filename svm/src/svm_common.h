...
#define MAX_NUM_VECTOR_PARM	100		//number of parameters in INI file
...
# define VERSION       "V5.01-TK-1.4.3_smoothing" // costumizable kernels
# define VERSION_DATE  "11.03.11"
...
typedef struct kernel_parm {
  ...
  char vector_kernel_params[1024];
  double similarity_threshold;//to use with PT SMOOTHING KERNELS
  char words_matrix_path[1024];//to use with PT SMOOTHING KERNELS
  char similarity_cache[1024];//to use with PT SMOOTHING KERNELS
  double terminal_factor;//to use with PT SMOOTHING KERNELS
  int sim_cache_size;//to use with PT SMOOTHING KERNELS
  int sim_cache_max_size;//to use with PT SMOOTHING KERNELS
  double sim_cache_refresh_factor;//to use with PT SMOOTHING KERNELS
...
extern double tree_kernel_not_norm(KERNEL_PARM * kernel_parm, DOC * a, DOC * b, int i, int j);
...
extern void setConfiguration(PAR_VEC * , KERNEL_PARM * );
extern void getConfiguration(KERNEL_PARM *kernel_parm, PAR_VEC *pv);
...
//Aggiunte da Crescenzo
extern PAR_VEC pv[MAX_NUM_VECTOR_PARM];
extern short CONFIG_VECT; // if 1 the vector of parameters is defined
extern void getValue(FILE * , char * , char * , char * );
void read_input_vector_kernel_param(KERNEL_PARM *kernel_parm);
extern double multi_vector_kernel(KERNEL_PARM *, DOC *, DOC * );
