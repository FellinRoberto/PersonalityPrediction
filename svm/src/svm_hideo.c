     ...
     double *buffer;
{
  ...
  //printf("IN optimize_hildreth_despo con n=%ld m=%ld precision=%lf epsilon_crit=%lf epsilon_a=%lf maxiter=%ld goal=%ld maxiter=%ld lindep_sensitivity=%lf\n", n, m, precision, epsilon_crit, epsilon_a, maxiter, goal, maxiter, lindep_sensitivity);
